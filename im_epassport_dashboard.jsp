...
try
	...
	while (rsTemp.next()) {
			...
			<tr style="font-size: 15px;  color:white; border-color: #3B7DD8;height:12px;border-radius: 20px;">
				...
				<th style="background-color:#6D5EB4;border-color: #efedf6; text-align: left;width:40%;">Country&nbsp;</th>
				<th style="background-color:#6D5EB4;border-color: #efedf6; text-align: right;width:15%;">Arrival&nbsp;</th>
				<th style="background-color:#6D5EB4;border-color: #efedf6; text-align: right;width:15%;">Departure&nbsp;</th>
				<th style="background-color:#6D5EB4;border-color: #efedf6; text-align: right;width:20%;">Total&nbsp;</th>
			</tr>
			<%
			}
			%>
