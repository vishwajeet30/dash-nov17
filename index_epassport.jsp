...
<title>e-Passport Clearance Statistics</title>
...
try{
	...
	stmt=con.prepareStatement("select ARR_EPASSPORT,DEP_EPASSPORT,LAST_UPDATE from IM_DASHBOARD_APIS_STATS");  
	...
	{ 
		...
		if(rs.getString("ARR_EPASSPORT") != null)
			arr_epassport = arr_epassport+rs.getInt("ARR_EPASSPORT");
		
		
		
		if(rs.getString("DEP_EPASSPORT") != null)
			dep_epassport = dep_epassport+rs.getInt("DEP_EPASSPORT");
	...
	stmt.close();
	////////////////////////////////////////////////////////22/08/2023
	stmt1=con.prepareStatement("select count(1) as arr_epassport from IM_TRANS_ARR_TOTAL where PAX_BOARDING_DATE > TO_DATE('"+last_update_date+"','dd/MM/yyyy') and EPASSPORT_FLAG = 'Y'");
		...
		stmt1=con.prepareStatement("select count(1) as dep_epassport from IM_TRANS_DEP_TOTAL where PAX_BOARDING_DATE > TO_DATE('"+last_update_date+"','dd/MM/yyyy') and EPASSPORT_FLAG = 'Y'");
		rs1=stmt1.executeQuery();  
		if(rs1.next())
		{ 
	...
	{ 
		...
		stmt1=con.prepareStatement("select count(1) as yes_arr_epassport from IM_TRANS_ARR_TOTAL where PAX_BOARDING_DATE = TO_DATE('"+yesterday_date+"','dd/MM/yyyy') and EPASSPORT_FLAG = 'Y'");
		rs1=stmt1.executeQuery();  
		if(rs1.next())
		{ 
		...
		rs1.close();
		stmt1.close();
		stmt1=con.prepareStatement("select count(1) as yes_dep_epassport from IM_TRANS_DEP_TOTAL where PAX_BOARDING_DATE = TO_DATE('"+yesterday_date+"','dd/MM/yyyy') and EPASSPORT_FLAG = 'Y'");
		rs1=stmt1.executeQuery();  
		if(rs1.next())
		{ 
	...
	/////////////////////////////////////////Today
		stmt1=con.prepareStatement("select count(1) as pax_pax from IM_TRANS_ARR_TOTAL where PAX_BOARDING_DATE = trunc(sysdate) and EPASSPORT_FLAG = 'Y'");
		rs1=stmt1.executeQuery();  
		if(rs1.next())
		{ 
		...
		rs1.close();
		stmt1.close();
		stmt1=con.prepareStatement("select count(1) as pax_pax_dep from IM_TRANS_DEP_TOTAL where PAX_BOARDING_DATE = trunc(sysdate) and EPASSPORT_FLAG = 'Y'");
		rs1=stmt1.executeQuery();  
		if(rs1.next())
		{ 
...
%>
 <script>
        ...
        let upto2 = <%=(dep_epassport+arr_epassport)-1700%>;
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<%@include file="header_epassport.html"%>
	<div>
...
try
	{
	SQLQUERY = "";
	SQLQUERY = "select PAX_BOARDING_DATE,count(1) as arr_epassport from IM_TRANS_ARR_TOTAL where PAX_BOARDING_DATE > trunc(sysdate-7) and EPASSPORT_FLAG = 'Y' group by PAX_BOARDING_DATE order by PAX_BOARDING_DATE";
	...
	while (rsTemp1.next())
		{
			...
			{
				psTemp=con.prepareStatement("select count(1) as dep_epassport from IM_TRANS_DEP_TOTAL where PAX_BOARDING_DATE = TO_DATE('"+formatter.format(rsTemp1.getDate("PAX_BOARDING_DATE"))+"','dd/MM/yyyy') and EPASSPORT_FLAG = 'Y' order by PAX_BOARDING_DATE");
...
<div class="card-body">
	...
	<canvas id="canvasPAX_Total" class="chart" style="background: linear-gradient(to bottom, #ffffff 20%, #fffaf2 100%);border-radius: 20px;height:400px;"></canvas>
</div>
</div>
</div>
				...
				<div class="col-md-6">
					...
					<div id="myCarousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<img src="slider_image/Year-wise_departure_e-Passport_Clearance.png" width="100%" style="height:420px;"/>
							</div>
							<div class="item">
							<img src="slider_image/Year-wise_Arrival_e-Passport_Clearance.png" width="100%" style="height:420px;"/>
							</div>
...
<BR>
	...
	<section class="content" style="padding: 17px;margin-top: -13px;margin-right: 20px;margin-left: 20px;margin-bottom: 13px;">
		<div class="row">
			<div class="col-md-4 col-sm-3 col-xs-12">
				<div class="info-box">
					...
					<div class="info-box-content">
						<span class="Today">Arrival e-Passport</span> 
						<span class="info-box-number" id="To_arr_epassport"></span>
			...
			<div class="col-md-4 col-sm-3 col-xs-12">
				<div class="info-box">
					...
					<div class="info-box-content">
						<span class="Today">Departure e-Passport</span> 
						<span class="info-box-number" id="To_dep_epassport"></span>
							<span class="Today">Today</span>
					</div>
					<!-- /.info-box-content -->
				</div>
			...
			<div class="col-md-4 col-sm-3 col-xs-12">
				<div class="info-box">
					...
					<div class="info-box-content">
						<span class="Today">Total e-Passport (Arr/Dep)</span>
						<span class="info-box-number" id="pax_pax_total"></span>
							<span class="Today">Today</span>
					</div>
					<!-- /.info-box-content -->
				</div>
		...
		<div class="row">
			<div class="col-md-4 col-sm-3 col-xs-12">
				<div class="info-box bg-olive">
					...
					<div class="info-box-content">
						<span class="Today">Arrival e-Passport</span> <span
			...
			<div class="col-md-4 col-sm-3 col-xs-12">
				<div class="info-box bg-orange">
					...
					<div class="info-box-content">
						<span class="Today">Departure e-Passport</span> <span
			...
			<div class="col-md-4 col-sm-3 col-xs-12">
				<div class="info-box bg-maroon">
					...
					<div class="info-box-content">
						<span class="Today">Total e-Passport (Arr/Dep)</span> <span
		...
		<div class="row">
			<div class="col-lg-4 col-xs-6">
				...
				<div class="small-box bg-olive">
					<div class="inner" style="padding: 7px;">
						<h3 id="arr_epassport"></h3>
						
						<p style="font-weight: bold;">Total Arrival e-Passport</p>
					</div>
					<div class="icon">
						<i class="fa fa-users"></i>
					</div>
					<p class="small-box-footer" style="text-align: left">Data Since 2010</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-xs-6">
				...
				<div class="small-box bg-orange">
					<div class="inner" style="padding: 7px;">
						...
						<p style="font-weight: bold;">Total Departure e-Passport</p>
					</div>
					<div class="icon">
						<i class="fa fa-users"></i>
					</div>
			...
			<div class="col-lg-4 col-xs-6">
				...
				<div class="small-box bg-maroon">
					<div class="inner" style="padding: 7px;">
						...
						<p style="font-weight: bold;">Total e-Passport (Arr/Dep)</p>
					</div>
					<div class="icon">
						<i class="fa fa-users"></i>
					</div>
	...
	var myoptions = {
			 ...
			 scales: {
				...
				yAxes: [{
				 ...
				 title: {
						display: true,
							text:'e-Passport Clearance in last 7 days',
						fontSize: 22,		
					  },
		tooltips: {
			enabled: true
    ...
    var area = new Morris.Area({
      ...
      data: [
         ...
         <%
		  ...
		  stmt1=con.prepareStatement("select PAX_BOARDING_DATE,count(1) as arr_epassport from IM_TRANS_ARR_TOTAL where PAX_BOARDING_DATE > trunc(sysdate-7) and EPASSPORT_FLAG = 'Y' group by PAX_BOARDING_DATE order by PAX_BOARDING_DATE");
		rs1=stmt1.executeQuery();  
		while(rs1.next())
		{
			if(rs1.getString("PAX_BOARDING_DATE") != null)
			{
			stmt=con.prepareStatement("select count(1) as dep_epassport from IM_TRANS_DEP_TOTAL where PAX_BOARDING_DATE = TO_DATE('"+formatter.format(rs1.getDate("PAX_BOARDING_DATE"))+"','dd/MM/yyyy') and EPASSPORT_FLAG = 'Y' order by PAX_BOARDING_DATE");
			rs=stmt.executeQuery();  
			if(rs.next())
			{	
		 %>
